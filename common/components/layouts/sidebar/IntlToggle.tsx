...
const IntlToggle = () => {
    ...
    return (
        <div className="flex items-center justify-center">
            ...
            >
                <motion.div
                    className="absolute bottom-1 top-1 w-10 rounded-full bg-neutral-300 text-neutral-700"
                    animate={{
                ...
                {locales.map((locale, index) => (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{
                                color: currentIndex === index ? "#302a2aff" : "#d7d6d6ff",
                            }}

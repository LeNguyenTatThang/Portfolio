...
const CodingActive = () => {
    ...
    useEffect(() => {
        const formatLastUpdate = (): void => {
            ...
            if (lastUpdateDate) {
                const utcDate = fromZonedTime(lastUpdateDate, "Asia/Ho_Chi_Minh")
                const zoneDate = toZonedTime(utcDate, "Asia/Ho_Chi_Minh")
    ...
    return (
        <section className="space-y-2">
            ...
            <SectionSubHeading>
                ...
                <Link
                    href="https://wakatime.com/@lenguyentatthang"
                    target="_blank"
